...
Follow the web setup instructions at: https://ravendb.net/docs/article-page/5.4/csharp/start/installation/setup-wizard

* Upgrading to a New Version
Follow the upgrade instructions available at: https://ravendb.net/docs/article-page/5.4/csharp/start/installation/upgrading-to-new-version
